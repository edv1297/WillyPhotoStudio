...
export class Nav extends React.Component{
	...
	handleScroll(){
		if(!this.state.collapsed && window.scrollY >= 100){
			window.document.getElementById("logo-main-img").src = "assets/logoblack.png";
			startAnimation(this, "navbar-collapse", ["navigator", "navigator-small"], 500);
		}else if(this.state.collapsed && window.scrollY < 100){
			window.document.getElementById("logo-main-img").src = "assets/logowhite.png";
	...
	render(){
		return(
			<div className={this.state.classes.join(" ")} role="navigation">
				...
				<div id="logo-main">
					<img height="30" width="150" src="assets/logowhite.png" id="logo-main-img"/>
				</div>
